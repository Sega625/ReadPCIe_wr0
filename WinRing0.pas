...
//                         (DWORD, 'value', 1))
  ...
  public type
    TStatus = (NO_ERROR = 0, DLL_NOT_FOUND = 1, DLL_INCORRECT_VERSION = 2, DLL_INITIALIZE_ERROR = 3);
    ...
    TGetDllVersion = function(var major, minor, revision, release: Byte): DWORD; stdcall;
    TGetDriverVersion = function(var major, minor, revision, release: Byte): DWORD; stdcall;
    TInitializeOls = function: BOOL; stdcall;
    TDeinitializeOls = procedure; stdcall;
    TIsMsr = function: BOOL; stdcall;
    TRdmsr = function(index: DWORD; var eax: DWORD; var edx: DWORD): BOOL; stdcall;
    TRdmsrTx = function(index: DWORD; var eax: DWORD; var edx: DWORD; threadAffinityMask: DWORD_PTR): BOOL; stdcall;
    TRdmsrPx = function(index: DWORD; var eax: DWORD; var edx: DWORD; processAffinityMask: DWORD_PTR): BOOL; stdcall;
    TWrmsr = function(index: DWORD; eax: DWORD; edx: DWORD): BOOL; stdcall;
    TWrmsrTx = function(index: DWORD; eax: DWORD; edx: DWORD; threadAffinityMask: DWORD_PTR): BOOL; stdcall;
    TWrmsrPx = function(index: DWORD; eax: DWORD; edx: DWORD; processAffinityMask: DWORD_PTR): BOOL; stdcall;

    TReadIoPortByte  = function(Addr: DWORD): byte; stdcall;
    TWriteIoPortByte = function(Addr: DWORD; Data: byte): BOOL; stdcall;
    TReadIoPortDword  = function(Addr: DWORD): DWORD; stdcall;
    TWriteIoPortDword = function(Addr: DWORD; Data: DWORD): BOOL; stdcall;
  private
    FModule: THandle;
    FStatus: TStatus;
  ...
  public
    ...
    property WriteIoPortByte: TWriteIoPortByte read FWriteIoPortByte;
    property ReadIoPortDword: TReadIoPortDword read FReadIoPortDword;
    property WriteIoPortDword: TWriteIoPortDword read FWriteIoPortDword;
